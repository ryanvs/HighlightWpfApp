...
namespace HighlightWpfApp
{
    ...
    /// 
    /// </summary>
    /// <see href="https://github.com/deanchalk/SearchMatchTextblock/blob/master/SearchMatchTextblock/HighlightingTextBlock.cs"/>
    [TemplatePart(Name = HighlightTextBlockName, Type = typeof(TextBlock))]
    public class HighlightingTextBlock : Control
    {
        private const string HighlightTextBlockName = "PART_HighlightingTextBlock";
